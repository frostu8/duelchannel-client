<script>
   ...
   * @property {number} padding - How much padding to apply to the display.
   * @property {string} height - The height of the counter.
   * @property {boolean} small - If small digits should be used to draw the
   * counter.
   * @property {string} class - Class names to apply.
   * @property {Children} children - The component's children.
   */
